...
import { VehicleHasCamperAddOn } from './App';
import { IVehicleSvgProps } from './Truck';

const Van = (props: IVehicleSvgProps) => {

	const {fill, hasAddOn} = props
	return (
		<>
		{ hasAddOn === VehicleHasCamperAddOn.yes ? <div className="van-camper"></div> : null }
		<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="0 0 501.333 501.333" >
<g>
	<g>
		<path fill={fill} d="M411.733,42.133H265.6C119.467,42.133,0,161.6,0,307.733V369.6c0,11.733,9.6,21.333,21.333,21.333h27.733
